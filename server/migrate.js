...
const REQUIRED_SCHEMA = {
  users: ['id', 'name', 'password_hash', 'email', 'email_verified_at', 'is_admin', 'is_banned', 'account_subject', 'account_status', 'account_tombstoned_at', 'auth_generation', 'avatar', 'avatar_revision', 'rating', 'bio', 'onboarded_at', 'avatar_frame', 'avatar_overlay', 'equipped_title', 'created_at'],
...
const REQUIRED_INDEXES = [
  ...
  'idx_submissions_status_queue',
  'idx_submissions_user_created',
  'idx_problem_revisions_problem',
  'idx_problem_status_history_problem',
